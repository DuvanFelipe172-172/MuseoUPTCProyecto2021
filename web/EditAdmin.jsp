                        ...
                        <div class="form-group">
                            <form action="ControladorAdmin" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtidAdmin" value="${administrador.getId()}"> <br>
                                </div>
                                <div class="form-group">
                                    <label>
                                        NOMBRE
                                    </label>
                                    <input type="text" name="txtnombreAdmin" value="${administrador.getNombre()}"> <br>
                                </div>
                                <div class="form-group">
                                    <label>
                                        APELLIDOS
                                    </label>
                                    <input type="text" name="txtapellidoAdmin" value="${administrador.getApellido()}"> <br>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="txtcorreoAdmin" value="${administrador.getEmail()}"> <br>
                                </div>
                                <div class="form-group">
                                    <label>
                                        CONTRASEÑA
                                    </label>
                                    <input type="password" name="txtcontraAdmin" value="${administrador.getContraseña()}"> <br>
                                </div>
