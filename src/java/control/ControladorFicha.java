    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(accion){
            ...
            case "Nuevo":
                ...
                List<Autor> datosAutor=  daoAutor.listar();
                request.setAttribute("datos", datosAutor);
            ...
            try {
                ...
                ficha.setEdadEjemplar(edadEjemplar);
            ...
            try {
                ...
                ficha.setId_Ejemplar(idF);
                ficha.setNombre(nombreF);
                ficha.setFilum(filumF);
                ficha.setTamaño(tamañoF);
                ficha.setPeso(pesoF);
                ficha.setProcedencia(procedenciaF);
                ficha.setFechaIngreso(fechaF);
                ficha.setEdadEjemplar(edadEjemplarF);
                ficha.setAutor(autorF);
