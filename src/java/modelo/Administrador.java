...
public class Administrador extends Usuario{
    ...
    public boolean buscadorAdmin(String id){
        return admins.stream().anyMatch(admin -> (admin.getId().equals(id)));
    }
    ...
    public boolean verificaContraseña(String id,String contraseña){
        return admins.stream().anyMatch(admin -> (admin.getContraseña().equals(contraseña) && admin.getId().equals(id)));
    }
